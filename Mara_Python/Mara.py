...
_command_prefix: callable = when_mentioned_or('ttr')
...
class Mara(Bot):
    ...
    def __init__(self, token: str, command_prefix=_command_prefix, description: str="""A multi-purpose bot for all kinds of tabletop role-playing games.
They are a nice child, take care of my child.""", intents: Intents=_intents, strip_after_prefix: bool=True) -> None:
        """Initializer of the TTRPG bot.
    ...
    def unload_extension(self, name: str, *, package: str=None) -> None:
    ...
    def ban_extension(self, name: str, *, package: str=None) -> None:
        """Bans an extension.
